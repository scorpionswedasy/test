...
class BuildColor {
  ...
  ///```
  Color get bottomAppBar => Theme.of(_context).primaryColorDark;
  ...
  ///```
  Color get selectedRow => Theme.of(_context).primaryColor;
  ...
  ///```
  Color get error => Theme.of(_context).primaryColorDark;

  ///```dart
  ///return Theme.of(context).toggleableActiveColor
  ///```
  Color get toggleableActive => Theme.of(_context).primaryColorDark;
}
