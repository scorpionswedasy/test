...
///
/// To integrate the [HashTagTextField] into a [Form] with other [FormField] widgets,
...
///
/// {@tool snippet}
/// This example shows how to create a [HashTagTextField] that will obscure input. The
...
class HashTagTextField extends StatefulWidget {
  ...
  /// [HashTagTextField.noMaxLength] then only the current length is displayed.
  ///
...
class _HashTagTextFieldState extends State<HashTagTextField>
    ...
    if (_hasIntrinsicError) {
      return effectiveDecoration.copyWith(
        ...
        counterStyle: effectiveDecoration.errorStyle ??
            themeData.textTheme.labelSmall!.copyWith(color: themeData.primaryColorDark),
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle style = theme.textTheme.labelSmall!.merge(widget.basicStyle);
    final Brightness keyboardAppearance =
